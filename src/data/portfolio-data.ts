...
export const projects = [
  ...
  { 
    ...
    description: "A simple tic tac toe mobile game for two players. They just enter their names and start playing and enjoying the game.", 
    icon: "Code",
    category: "Mobile Game",
    github: "https://github.com/mahmoudnader150/tic_tac_toe_game.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
  { 
    title: "Task Manager", 
    description: "This is a simple Todo application built to help manage your tasks efficiently. The app allows you to add, edit, delete, and sort tasks.", 
    icon: "Code",
    category: "Web Application",
    github: "https://github.com/mahmoudnader150/Todo-Application.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
  { 
    title: "Habit tracker", 
    description: "The Simple Habit Tracker App is a mobile application built with Flutter that helps users track their habits and visualize their progress using a heat map.", 
    icon: "Code",
    category: "Mobile Application",
    github: "https://github.com/mahmoudnader150/habit_tracker.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
  ...
  { 
    title: "Gauss Jaccobi calculator", 
    description: "Gauss Jacobi Calculator solves equations with three and four different variables. The calculator was developed using Python.", 
    icon: "Code",
    category: "Software & Mathematics",
    github: "https://github.com/mahmoudnader150/Gauss-Jaccobi.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
  { 
    ...
    description: "Simple web application that manages students and courses, developed with HTML, CSS, JavaScript, and Django.", 
    icon: "Code",
    category: "Web Application",
    github: "https://github.com/mahmoudnader150/Student_Affairs_Website.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
  { 
    title: "Producer and Consumer Threads", 
    description: "Producer and Consumer problem about threading in Java, printing prime numbers at some N in a file.", 
    icon: "Code",
    category: "OS & Software engineering",
    github: "https://github.com/mahmoudnader150/Producer-and-Consumer-Threads-in-JAVA-.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
  { 
    title: "Garage system", 
    description: "A simple garage parking system built using Java by applying best-fit and first-in-first-out approaches.", 
    icon: "Code",
    category: "Software engineering",
    github: "https://github.com/mahmoudnader150/Garage-system.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
  { 
    ...
    description: "A desktop library system that manages authors and books by running different queries on a relational database.", 
    icon: "Code",
    category: "Database & Software engineering",
    github: "https://github.com/mahmoudnader150/Library-System.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
  { 
    ...
    description: "API system that manages students and courses and allows sorting.", 
    icon: "Code",
    category: "API",
    github: "https://github.com/mahmoudnader150/sudentManagmentSystem.git",
    image: "/placeholder.svg",
    liveLink: "#",
    featured: false
  },
...
export const experiences = [
  { 
    title: "Competitive Programmer @ECPC", 
    ...
    description_points: [
      ...
      "Developed strong problem-solving skills in data structures and algorithms",
      "Collaborated with team members to solve complex programming challenges",
      "Strengthened logical thinking and algorithmic problem-solving approach"
    ],
    technologies: ["C++", "Algorithms", "Data Structures", "Problem Solving"]
  },
  { 
    title: "Fullstack developer trainee @ITI", 
